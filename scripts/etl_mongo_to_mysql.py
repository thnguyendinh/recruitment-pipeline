...
MONGO_URI = "mongodb://admin:admin123@mongodb:27017/recruitment.tracking?authSource=admin"
MYSQL_URL = "jdbc:mysql://mysql:3306/warehouse?useSSL=false"
MYSQL_USER = "root"
MYSQL_PWD = "example"
LAST_TS_FILE = "/opt/spark/last_timestamp.txt"

spark = SparkSession.builder \
    .appName("ETL MongoDB to MySQL") \
    .config("spark.jars.packages", "org.mongodb.spark:mongo-spark-connector_2.12:10.4.0,com.mysql:mysql-connector-j:8.0.30") \
